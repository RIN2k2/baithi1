...
<div class="container">
	...
	<div class="beta-products-list">
		<h4>Sản Phẩm Gần Nhất</h4>
		<div class="beta-products-details">
			<p class="pull-left">4 sản Phẩm</p>
					...
					<div class="single-item-caption">
						...
						<div class="d-flex align-items-center">
							...
							<form action="{{ route('getLike', ['id' => $productId]) }}" method="POST">
								@csrf
								<button type="submit" class="btn btn-primary"><span class="heart-icon">&#10084;</span>
								</button>
							</form>
							@else
							<form action="{{ route('getLike', ['id' => $productId]) }}" method="POST">
							...
							@endif
							<a class="beta-btn primary ml-3" href="{{ route('show', ['id' => $recommended_product->id]) }}">Chi tiết <i class="fa fa-chevron-right"></i></a>
						</div>
						@else
						<form action="{{ route('getLike', ['id' => $recommended_product->id]) }}" method="POST">
							@csrf
								...
								<div class="single-item">
									...
									<div class="single-item-caption">
										...
										<div class="d-flex align-items-center">
											...
											<form action="{{ route('getLike', ['id' => $productId]) }}" method="POST">
												@csrf
												<button type="submit" class="btn btn-primary"><span class="heart-icon">&#10084;</span></button>
											</form>
											@else
											<form action="{{ route('getLike', ['id' => $productId]) }}" method="POST">
												@csrf
											...
											@endif
											<a class="beta-btn primary ml-3" href="{{ route('show', ['id' => $new_product->id]) }}">Chi tiết <i class="fa fa-chevron-right"></i></a>
										</div>
										@else
								...
								<div class="single-item">
									...
									<div class="single-item-caption">
										...
										<div class="d-flex align-items-center">
											...
											@endif
											<a class="beta-btn primary ml-3" href="{{ route('show', ['id' => $products->id]) }}">Chi tiết<i class="fa fa-chevron-right"></i></a>
										</div>
										@else
