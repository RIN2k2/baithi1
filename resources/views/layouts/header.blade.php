		...
		<div class="container">
			<div class="pull-left auto-width-left">
				<ul class="top-menu menu-beta l-inline">
					<li><a href=""><i class="fa fa-home"></i> Shop Hoa tươi Gia Hân, 63 Lê Hồng Phong, Quận Sơn Trà</a></li>
					<li><a href=""><i class="fa fa-phone"></i> 0968 641 613</a></li>
				</ul>
			</div>
				...
				<div class="beta-comp">
					<div class="cart">
						<div class="beta-select">
							...
							@else @endif)<i class="fa fa-chevron-down"></i>
						</div>
						<div class="beta-dropdown cart-body">
							...
							<div class="cart-caption">
								<div class="cart-total text-right">Tổng tiền: <span class="cart-total-value">{{isset($totalPrice) ? $totalPrice : 0}}</span></div>
								<div class="clearfix"></div>
		...
		<div class="container">
			...
			<nav class="main-menu">
				<ul class="l-inline ov">
					...
					<li><a href="/about">Chủ đề</a></li>
					<li><a href="/about">Thiết kế</a></li>
					<li><a href="/about">Hoa tươi</a></li>
					<li><a href="/about">Quà tặng</a></li>
